...
namespace Aimirim.iView
{
    ...
    public class ColorTableCollection : CollectionBase, ICustomTypeDescriptor
    {
        ...
        /// </summary>
        public ColorTable this[int index]
        {
            get
            {
                return (ColorTable)this.List[index];
            }
        }
        ...
        public PropertyDescriptorCollection GetProperties()
        {
            ...
            for (int i = 0; i < this.List.Count; i++)
            {
                ...
                ColorTableCollectionPropertyDescriptor pd = new ColorTableCollectionPropertyDescriptor(this, i);
                pds.Add(pd);
            }
