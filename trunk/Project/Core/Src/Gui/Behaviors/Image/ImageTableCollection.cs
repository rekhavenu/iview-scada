...
namespace Aimirim.iView
{
    ...
    public class ImageTableCollection : CollectionBase, ICustomTypeDescriptor
    {
        ...
        /// </summary>
        public ImageTable this[int index]
        {
            get
            {
                return (ImageTable)this.List[index];
            }
        }
        ...
        public PropertyDescriptorCollection GetProperties()
        {
            ...
            for (int i = 0; i < this.List.Count; i++)
            {
                ...
                ImageTableCollectionPropertyDescriptor pd = new ImageTableCollectionPropertyDescriptor(this, i);
                pds.Add(pd);
            }
