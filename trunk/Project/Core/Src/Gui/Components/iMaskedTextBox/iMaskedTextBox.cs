...
namespace Aimirim.iView
{
	...
	[ToolboxItem(false)]
	[ToolboxBitmapAttribute(typeof(iMaskedTextBox))]
	public class iMaskedTextBox : MaskedTextBox, ISupportInitialize
	{
		#region FIELDS
		private ITag _tag;
		private string _inputTag;
		private iMaskedTextBoxAnimotion _animotion;
		...
		public iMaskedTextBoxAnimotion Animotion
		{
			get
			{
				if (_animotion == null)
				{
					_animotion = new iMaskedTextBoxAnimotion();
				}
				return _animotion;
			}
			set
